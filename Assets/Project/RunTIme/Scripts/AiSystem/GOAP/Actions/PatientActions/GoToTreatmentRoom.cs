namespace AnotherWorldProject.AISystem.GOAP.Core
{
    public class GoToTreatmentRoom : GAction
    {
        public override bool PreActionExecute()
        {
            ...
            target.GetComponent<GLocation>().GetStateHandler().ModifyState(new("PatientWaiting", -1));
        ...
        public override bool PostActionExecute()
        {
            ...
            target.GetComponent<GLocation>().GetStateHandler().ModifyState(new("PatientWaitingForTreatment", 1));
